...
import cn.momosv.websocket.dataSource.DatasourceConfig;
...
@MapperScan({"cn.momosv.websocket.dao","cn.momosv.websocket.dao1"})
@Configuration
    ...
    //  加载全局的配置文件
        ...
        public SqlSessionFactory sqlSessionFactory() {
            try {
                ...
                //设置mapper.xml文件所在位置
                mapperLocations.addAll(extMapperLocations);
